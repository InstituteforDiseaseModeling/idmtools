...
class LocalPlatform(IPlatform):
    ...
    def retrieve_experiment(self, experiment_id: str) -> 'TExperiment':
        """
        ...
        experiment.uid = experiment['uuid']
        return experiment
    ...
    def restore_simulations(self, experiment: 'TExperiment'):
        ...
        for sim_info in simulation_dict:
            ...
            sim.uid = sim_info['uuid']
            sim.tags = sim_info['tags']
            sim.status = sim_info['status']
    ...
    def retrieve_output_files(self, job_id_path, paths):
        ...
        for path in paths:
            full_path = os.path.join(self.host_data_directory, job_id_path, path)
