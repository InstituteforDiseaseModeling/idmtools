...
class TestSimulationBuilder(ITestWithPersistence):
    ...
    def testArmSimulationBuilderWithCumulateArm(self):
        """
            ...
            Expect sims with parameters:
                ...
                sim3: {a:1, b:3, c:4}
                sim4: {a:1, b:3, c:5}
                sim5: {a:1, b:2, c:4, a:6, b:2}
                sim6: {a:1, b:2, c:4, a:7, b:2}
                sim7: {a:1, b:2, c:5, a:6, b:2}
                sim8: {a:1, b:2, c:5, a:7, b:2}
                sim9: {a:1, b:3, c:4, a:6, b:2}
                sim10: {a:1, b:3, c:4, a:7, b:2}
                sim11: {a:1, b:3, c:5, a:6, b:2}
                sim12: {a:1, b:3, c:5, a:7, b:2}
        """
        ...
        real_tags = [
            {key: value for key, value in simulation.tags.items() if key != exclude_key}
    ...
    def testArmSimulationBuilderWithTwoArms(self):
        ...
        # define our second sweep Sweep Arm
