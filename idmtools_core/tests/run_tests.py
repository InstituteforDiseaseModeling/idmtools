...
sys.path.insert(0, os.path.abspath(os.path.join(root_idmtools, "idmtools_local_runner")))
sys.path.insert(0, os.path.abspath(os.path.join(root_idmtools, "idmtools_models_collection")))
