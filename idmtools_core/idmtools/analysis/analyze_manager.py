...
class AnalyzeManager:
    ...
    def __init__(self, platform: 'IPlatform' = None, configuration: dict = None,
        ...
        Args:
            ...
            max_workers (int, optional): Set the max workers. If not provided, falls back to the configuration item *max_workers*. If max_workers is not set in configuration, defaults to CPU count
