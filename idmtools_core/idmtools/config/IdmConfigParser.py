...
class IdmConfigParser:
    ...
    def retrieve_settings(cls, section: str = None, field_type: Dict[str, str] = {}) -> Dict[str, str]:
        """
        Called from each platform. Retrieve INI configuration values (to be used when updating platform fields).
    ...
    def get_section(cls, section: str = None) -> Dict[str, str]:
        """
        Call from platform creation directly and retrieve INI section values.
    ...
    def clear_instance(cls) -> None:
        """
        Clear the un_init and :class:`IdmConfigParser` instance. 
