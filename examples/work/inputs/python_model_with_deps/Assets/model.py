...
if __name__ == "__main__":
    ...
    # The local platform needs to know the resulting status of a work item. We provide it through a return code	    print(f"Simulation running with Run_Number = {run_number}")
