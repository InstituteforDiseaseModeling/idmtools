...
class Sim(ParsObj):
        ...
        for t in range(self.npts):
            ...
            for person in self.people.values():
                ...
                if person.infectious:
                    ...
                    if person.date_recovered and t >= person.date_recovered:  # It's the day they become infectious
                        ...
                        contact_inds = cov_ut.choose_people(max_ind=len(self.people),
                ...
                if n_tests and not pl.isnan(n_tests):  # There are tests this day
                    ...
                    for test_ind in test_inds:
                        ...
                        if tested_person.infectious and cov_ut.bt(
                                self['sensitivity']):  # Person was tested and is true-positive
            ...
            if t < len(evacuated):
                ...
                if n_evacuated and not pl.isnan(
                        n_evacuated):  # There are evacuees this day # TODO -- refactor with n_tests
                    if verbose >= 1:
    ...
    def plot(self, do_save=None, fig_args=None, plot_args=None, scatter_args=None, axis_args=None, as_days=True,
             font_size=18, verbose=None):
        '''
        ...
        if axis_args is None: axis_args = {'left': 0.1, 'bottom': 0.05, 'right': 0.9, 'top': 0.97, 'wspace': 0.2,
                                           'hspace': 0.25}
