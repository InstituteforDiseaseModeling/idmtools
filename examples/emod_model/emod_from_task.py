# example to use CommandTask to generate 1 simulation
import os
import sys
...
def generate_sim():
    ...
    experiment = Experiment.from_task(task, name="example--emod_from_task.py", assets=ac)
...
if __name__ == "__main__":
    ...
    sims = generate_sim()
    sys.exit(0 if sims[0].succeeded else -1)