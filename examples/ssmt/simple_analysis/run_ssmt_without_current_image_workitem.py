...
from examples.ssmt.simple_analysis.analyzers.ExampleAnalyzer import ExampleAnalyzer
...
analysis = PlatformAnalysis(platform=platform, work_item_ids=["c956aef5-5844-f011-aa22-b88303911bc1"],
                            analyzers=[ExampleAnalyzer],
                            analyzers_args=[{'name': 'idm'}], analysis_name="SSMT Analysis workitem",
