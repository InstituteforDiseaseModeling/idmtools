...
The :py:class:`~idmtools_platform_comps.utils.singularity_build.SingularityBuildWorkItem` can also build using jinja templates. The template should produce a singularity definition file when rendered.
