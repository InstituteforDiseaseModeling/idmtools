...
Adapted from https://github.com/edreamleo/make-stub-files by Clinton Collins to give sorted, consistent output
'''
import ast
...
class Controller:
    ...
    def scan_options(self):
        ...
        files2 = []
        for z in files:
            files2.extend(glob.glob(self.finalize(z), recursive="**" in z))
...
class StubTraverser(ast.NodeVisitor):
    ...
    def output_stubs(self, stub):
        ...
        for child in sorted(stub.children):
