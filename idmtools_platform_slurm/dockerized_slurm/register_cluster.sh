...
#
#sacctmgr add account test Cluster=linux Description="none" Organization="none"
#
...
docker exec slurmctld bash -c "/usr/bin/sacctmgr --immediate add user da DefaultAccount=test"
