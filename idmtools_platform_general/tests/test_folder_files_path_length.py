...
from idmtools_platform_general.idmtools_platform_file.platform_operations.utils import validate_file_copy_path_length, \
    validate_folder_files_path_length
...
class TestValidateFolderFilesPathLength(unittest.TestCase):
    ...
    @patch('idmtools_platform_general.idmtools_platform_file.platform_operations.utils.is_windows', return_value=True)
    @patch('idmtools_platform_general.idmtools_platform_file.platform_operations.utils.is_long_paths_enabled', return_value=False)
    @patch('idmtools_platform_general.idmtools_platform_file.platform_operations.utils.get_max_filepath', return_value='a' * 200)
    @patch('idmtools_platform_general.idmtools_platform_file.platform_operations.utils.user_logger')
    ...
    @patch('idmtools_platform_general.idmtools_platform_file.platform_operations.utils.is_windows', return_value=True)
    @patch('idmtools_platform_general.idmtools_platform_file.platform_operations.utils.is_long_paths_enabled', return_value=False)
    @patch('idmtools_platform_general.idmtools_platform_file.platform_operations.utils.get_max_filepath', return_value='a' * 270)
    @patch('idmtools_platform_general.idmtools_platform_file.platform_operations.utils.user_logger')
    ...
    @patch('idmtools_platform_general.idmtools_platform_file.platform_operations.utils.is_windows', return_value=True)
    @patch('idmtools_platform_general.idmtools_platform_file.platform_operations.utils.is_long_paths_enabled', return_value=False)
    @patch('idmtools_platform_general.idmtools_platform_file.platform_operations.utils.get_max_filepath', return_value=None)
    @patch('idmtools_platform_general.idmtools_platform_file.platform_operations.utils.validate_file_path_length')
    @patch('idmtools_platform_general.idmtools_platform_file.platform_operations.utils.user_logger')
    ...
    @patch('idmtools_platform_general.idmtools_platform_file.platform_operations.utils.is_windows', return_value=True)
    @patch('idmtools_platform_general.idmtools_platform_file.platform_operations.utils.is_long_paths_enabled', return_value=True)
    @patch('idmtools_platform_general.idmtools_platform_file.platform_operations.utils.validate_file_path_length')
    ...
    @patch('idmtools_platform_general.idmtools_platform_file.platform_operations.utils.is_windows', return_value=False)
    @patch('idmtools_platform_general.idmtools_platform_file.platform_operations.utils.is_long_paths_enabled')
    @patch('idmtools_platform_general.idmtools_platform_file.platform_operations.utils.validate_file_path_length')
